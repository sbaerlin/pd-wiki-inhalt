...
- **Preis pro Tankstelle:** 500.000 €
- Nach dem Kauf startet die Tankstelle mit **einer Zapfsäule**.

Nach dem Erwerb kann der Besitzer:
...
- Der Ankauf von Treibstoff wird **direkt aus der Tankstellenkasse bezahlt**.
- Es gibt **keine automatische Abbuchung vom Spielerkonto**.

Wenn Spieler an der Tankstelle tanken:
...
- **Wartungsintervall:** alle 14 Tage
- Die Wartung erfolgt beispielsweise durch die **Straßenwacht**.

Wird die Wartung nicht innerhalb von 14 Tagen durchgeführt:

- wird die Tankstelle **automatisch wieder zum Verkauf freigegeben**.
...
Spieler können dort folgende Informationen sehen:

- Ankaufspreis der Tankstelle
- Verkaufspreis der Tankstelle
- aktuellen **Füllstand des Tanks**
